...
.. note::
    **Even if you and other nearby users are on the same frequency, your PCB will ignore the signals from other PCBs.**
    ...
    Your PCB only cares about the payloads that carry these specific hash bytes.
